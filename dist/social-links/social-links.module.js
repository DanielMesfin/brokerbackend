...
const social_links_controller_1 = require("./social-links.controller");
...
exports.SocialLinksModule = SocialLinksModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [social_links_controller_1.SocialLinksController],
        providers: [social_links_service_1.SocialLinksService],
        exports: [social_links_service_1.SocialLinksService],
    })
], SocialLinksModule);
